...
def all_posts(request, unit_name=None):
    ...
    return render(request, 'lms/all_posts.html', context)
...
def reply_to_post(request, post_id):
    ...
    return render(request, 'lms/reply_form.html', context)
...
def user_profile(request, username):
    ...
    return render(request, 'lms/user_profile.html', context)
...
def edit_post(request, post_id):
    ...
    context = {'form': form}
    return render(request, 'lms/edit_post.html', context)
...
def leaderboard_view(request):
    ...
    for user in users:
        try:
            if hasattr(user, 'wallet'):  # Change to hasattr to check attribute
             ...
             leaderboard_data.append((user, 0))

    if not leaderboard_data:
         # Add some fake data for the screenshot
         leaderboard_data = [(type('obj', (object,), {'username': 'Student A'}), 500), (type('obj', (object,), {'username': 'Student B'}), 300)]
    ...
    return render(request, 'lms/leaderboard.html', context)
